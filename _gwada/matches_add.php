...
<?php /*<fieldset style="width:70%; float:left">*/ ?>
    ...
    Titre<br/>
    <input id="matches_label" name="label" type="text" value="" size="50" maxlength="250"/> <a href="#"
                                                                                               onclick="$('matches_label').value = ''">X</a><br/>
    Titre prédéfinis : <a href="#" onclick="$('matches_label').value = 'Championnats européens'">Championnats
        européens</a>
    <br/><br/>
    <?php
    /*
    ...
    */
    ...
    <fieldset>
        <legend>Classements Généraux</legend>
        <?php
    ...
    <fieldset>
        <legend>Classement mensuel</legend>
        <?php
        // classement mensuel ?
        $SQL = "SELECT `pp_class`.`id_class`, `pp_class`.`label`, `pp_info_country`.`label` AS `country`
			FROM `pp_class` LEFT JOIN `pp_info_country` ON `pp_info_country`.`id_info_country`=`pp_class`.`id_info_country`

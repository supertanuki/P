...
?>
    <fieldset>
        ...
        <form method="post">
            Année de la saison : <input type="text" name="annee" value="<?php echo date("Y") - 1; ?>" size="4"
                                        maxlength="4"/><br/><br/>
            <input type="submit" name="enregistrer_archives" value="Enregistrer"
                   style="padding: 6px; background-color: rgb(204, 204, 204);"/><br/><br/>
    ...
    <fieldset>
        ...
        <form method="post" onsubmit="return confirm('Êtes-vous certain ?')">
            ...
            <input type="submit" name="supprimer_saison" value="Supprimer la saison"
                   style="padding: 6px; background-color: rgb(255, 34, 34); color: rgb(255, 255, 255);"/>
        </form>
    </fieldset>
<?php

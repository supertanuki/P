...
?>
    ...
    <fieldset>
        ...
        <form method="post">
            ...
            Label : <input name="label" type="text" size="30"
                           value="<?php echo $_POST[rechercher] && $_POST[label] ? htmlspecialchars($_POST[label]) : ''; ?>"/>
            %<br/><br/>
    ...
    <fieldset>
		...
		ORDER BY `label`";
            ...
            Label : <input name="label" type="text" size="50"
                           value="<?php echo $team ? htmlspecialchars($team->label) : ''; ?>"/><br/><br/>

            Xlabels : <input name="xlabels" type="text" size="70"
                             value="<?php echo $team ? htmlspecialchars($team->xlabels) : ''; ?>"/><br/><br/>

            Flag : <input name="flag" type="text" size="70"
                          value="<?php echo $team ? htmlspecialchars($team->flag) : ''; ?>"/><br/><br/>

            Featured : <input name="featured" type="checkbox"
                              value="1" <?php echo $team && $team->featured ? 'checked' : ''; ?> /><br/><br/>

            Nb points sanction : <input name="nb_points_sanction" type="text" size="3"
                                        value="<?php echo $team ? htmlspecialchars($team->nb_points_sanction) : '0'; ?>"/><br/><br/>

...
if(isset($_REQUEST['action']) and $_REQUEST['action']) { // Quiz Reuslts.
	...
	$result = '';
	$result .= "<p>" . t('Voici les résultats question par question :') . "</p>";
...
<input type="button" id="show-answer" value="<?php e("Voir la réponse") ?>"  /><br />
<?php } else { ?>
<input type="button" id="next-question" value="<?php e("Valider et passer à la suite") ?> &gt;"  /><br />
<?php } ?>

<input type="submit" name="action" id="action-button" value="<?php e("Voir les résultats") ?>"  />

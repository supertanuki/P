...
?>
    <ul id="msgbugsafari" class="pageitem">
        <li class="textbox">
            <div>BUG sur Safari Mobile : impossible de se connecter... En attendant que ce bug soit résolu, essayez
    ...
    <div id="login_form" style="display:none">
        <form method="post" action="" onsubmit="return pp_login();">
            <ul class="pageitem">
                <li class="smallfield"><span class="name">Pseudo</span><input id="connect_login"
                                                                              placeholder="Ton pseudo" type="text"/>
                </li>
                <li class="smallfield"><span class="name">Mot de passe</span><input id="connect_password"
                                                                                    placeholder="Ton mot de passe"
                                                                                    type="password"/></li>
                <li class="checkbox"><span class="check"><span class="name">Rester connecté</span><input
                            id="connect_permanent" name="remember" type="checkbox"/></span></li>

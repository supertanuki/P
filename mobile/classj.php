    ...
    <ul class="pageitem">
        ...
        <li class="textbox">
            <?php if ($msg_not_provisoire && !$pp_matches->id_cup_matches) { ?>
                <p style="color:red; font-weight:bold;">Le classement provisoire n'a pas encore été fait. Rendez-vous
                    sur le site version normale pour le faire !</p>
            <?php } ?>
            <p>
                ...
                <li class="textbox">
                    <table width="100%" cellpadding="2" cellspacing="1">
                        ...
                        <tr<?php echo $cup_user->id_user_host == $cup_user->id_user_won ? ' style="background:yellow"' : ''; ?>>
                            <td align="center"><img src="<?php echo $avatar_host; ?>" height="30" width="30" border="0"
                                                    align="absmiddle"/></td>
                    ...
                    if (DB::isError($result)) {
                        ...
                        <tr>
                            <td colspan="4" align="center"><a
                                    href="/classj.php?id=<?php echo $pp_matches->id_matches; ?>" class="link_orange">Voir
                                    le classement complet sur la version normale de Prono+</a></td>
                        </tr>
                    <?php
                    }
                    ?>
        ...
        <?php if ($modifier_prono) { ?>
            <li class="button"><input name="Submit input" type="submit" value="Modifier mes pronostics"/></li><?php } ?>
    </ul>
